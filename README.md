...
OR
eksctl create cluster -f three-tier-cluster.yaml ### if you have three-tier-cluster.yaml
...
OR
eksctl delete cluster --name three-tier-cluster --region ap-south-1 --disable-nodegroup-eviction
